...
gcreg fits constrained regression models. The package is currently still being developed and tested, but functionality for constrained polynomial regression models is available with the function cpm(). This vignette will demonstrate some examples of constrained polynomial regression.
...
Use the make_oracle() function to define your own constraints.

```{r}

# # Constraint: T if beta[2] >= 3, F otherwise
# b3_g1 <- function(b){
#   b[3,1] >= 1
# }
# 
...
# 
# c_model <- cpm(height ~ day, data = fda::onechild, degree = deg, 
#                oracle = orc_f, start = start_beta, step_start = 0.7)
