...
```{r, fig.show='hold', fig.cap='fda::growth data', cache=TRUE}
library(fda)
library(ggplot2)
library(dplyr)
...
Currently `gcreg:::constrained_lmm_em()` returns a list with the relevant values.  Below are some examples interacting with this fits.
